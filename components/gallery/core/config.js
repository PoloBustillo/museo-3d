...
export const GALLERY_CONFIG = {
  ...
  // Texturas (prefijos base para mapas PBR)
  TEXTURES: {
    FLOOR: "/assets/textures/WoodFloor003_1K-JPG/WoodFloor003_1K-JPG",
    WALL: "/assets/textures/Rock050_1K-JPG/Rock050_1K-JPG",
    FALLBACKS: [
      "/assets/textures/DiamondPlate006C_1K-JPG/DiamondPlate006C_1K-JPG",
    ],
  },
