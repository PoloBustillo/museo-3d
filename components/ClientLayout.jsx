            ...
            {transitioning && (
              ...
              >
                ...
                <motion.div
                  ...
                  style={{
                    boxShadow:
                      "0 0 20px rgba(147, 51, 234, 0.5), 0 0 40px rgba(244, 114, 182, 0.3)",
                  }}
                />
                <motion.div
                  ...
                  style={{
                    boxShadow:
                      "0 0 15px rgba(59, 130, 246, 0.6), 0 0 30px rgba(14, 165, 233, 0.4)",
                  }}
                />
                <motion.div
                  ...
                  style={{
                    boxShadow:
                      "0 0 18px rgba(34, 197, 94, 0.5), 0 0 35px rgba(16, 185, 129, 0.3)",
                  }}
                />
                <motion.div
                  ...
                  style={{
                    boxShadow:
                      "0 0 12px rgba(251, 191, 36, 0.6), 0 0 25px rgba(249, 115, 22, 0.4)",
                  }}
                />
                <motion.div
                  ...
                  style={{
                    boxShadow:
                      "0 0 16px rgba(99, 102, 241, 0.5), 0 0 32px rgba(139, 92, 246, 0.3)",
                  }}
                />
                ...
                <motion.img
                  ...
                  style={{
                    ...
                    height: "auto",
                    filter:
                      "brightness(1.1) contrast(1.1) drop-shadow(0 20px 25px rgba(0, 0, 0, 0.4)) drop-shadow(0 8px 10px rgba(0, 0, 0, 0.2)) drop-shadow(0 0 40px rgba(147, 51, 234, 0.2))",
                  }}
                />
                <motion.span
                  ...
                  style={{
                    textShadow:
                      "0 4px 8px rgba(0, 0, 0, 0.6), 0 2px 4px rgba(0, 0, 0, 0.4), 0 0 20px rgba(147, 51, 234, 0.3)",
