...
function CameraLerpTo({ target, cameraRef, onArrive }) {
  ...
  useFrame(() => {
    ...
    if (
      !arrivedRef.current &&
      cam.position.distanceTo(new THREE.Vector3(...position)) < 0.1
    ) {
    ...
    if (
      arrivedRef.current &&
      cam.position.distanceTo(new THREE.Vector3(...position)) > 0.2
    ) {
  ...
  useFrame(() => {
    if (cameraTarget) {
      ...
      if (!transitionStarted.current) {
        ...
        console.log(
          "Transición de cámara iniciada - orientación inicial aplicada"
        );
      }
      ...
      if (distanceToTarget < 0.1) {
        ...
        console.log(
          "Transición de cámara completada - controles totalmente liberados"
        );
      }
    } else {
      transitionStarted.current = false;
...
function ZoomModal({ artwork, onClose, onCollectionUpdate, userId }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ marginBottom: "10px", fontWeight: "bold", color: "#ffe082" }}
        >
        ...
        <div style={{ fontSize: "12px", marginBottom: "8px" }}>
          ⌨️ ESC/C : Cerrar y reactivar cámara
        </div>
      </div>
      ...
      {scale <= 1 && (
        ...
        >
          ...
          >
            <span>
              <strong>Técnica:</strong> {artwork.technique}
            </span>
            <span>
              <strong>Dimensiones:</strong> {artwork.dimensions}
            </span>
          </div>
          ...
          >
            <button
              ...
              onMouseEnter={(e) => {
                e.target.style.background = isInCollection
                  ? "rgba(255, 87, 34, 0.2)"
                  : "rgba(76, 175, 80, 0.2)";
            ...
            >
              {isInCollection
                ? "🗑️ Remover de mi colección"
                : "❤️ Guardar en mi colección"}
            </button>
...
export default function GalleryRoom({
  ...
  const roomsToShow =
    availableRooms.length > 0
      ? availableRooms
      : GALLERY_CONFIG.AVAILABLE_ROOMS.map((room) => ({
          ...room,
  ...
  useEffect(() => {
    ...
    if (cameraRef && artworks.length > 0 && !showInstructions) {
      console.log(
        `Sala ${salaId} cargada - verificando si necesita reposicionamiento`
      );
      ...
      if (currentX < galleryStartX - 8 || currentX > galleryEndX + 8) {
        ...
        console.log(
          `Cámara fuera del rango (${currentX}), reposicionando al centro [${centerX}, ${cameraY}, ${cameraZ}]`
        );
    ...
    <>
              ...
              <li
                ...
                style={{
                  ...
                  background:
                    moveTo === i
                      ? "#ffe082"
                      : selectedArtwork && selectedArtwork.title === art.title
                      ? "#b3e5fc"
                      : listIndex === i
                      ? "#fffde7"
                      : "transparent",
                  ...
                  transition: "background 0.2s, box-shadow 0.2s",
                  fontWeight:
                    moveTo === i || listIndex === i ? "bold" : "normal",
      ...
      {showInstructions && !selectedArtwork && !showList && (
        ...
        >
          ...
          >
            <div style={{ fontSize: "2.2em", marginBottom: "0.4em" }}>
              � Museo Virtual 3D
            </div>
            <div
              style={{
            ...
            >
              Bienvenido/a al recorrido interactivo
            </div>
            <ul
              style={{
                textAlign: "left",
            ...
            >
              <li>
                <b>WASD</b> o <b>Flechas</b>: Moverse por el espacio
              </li>
              <li>
                <b>Mouse</b>: Mirar alrededor
              </li>
              <li>
                <b>Clic en cuadro</b>: Ver detalles y zoom
              </li>
              <li>
                <b>L</b>: Abrir/cerrar lista de obras
              </li>
              <li>
                <b>M</b>: Ver mi colección personal
              </li>
              <li>
                <b>🔊</b>: Activar/desactivar sonido
              </li>
            </ul>
            <div
              style={{
          ...
          {personalCollection.length === 0 ? (
            ...
            >
              ...
              <div style={{ fontSize: "12px", opacity: 0.8 }}>
                Haz clic en las obras y usa "❤️ Guardar en mi colección" para
                añadirlas aquí
              </div>
            </div>
          ) : (
            ...
            {personalCollection.length > 0 && (
              <button
                onClick={() => {
                  if (
                    confirm(
                      "¿Estás seguro de que quieres limpiar toda tu colección?"
                    )
                  ) {
