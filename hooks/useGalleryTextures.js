...
const TEXTURE_MAP = {
  ...
  DiamondPlate: "/assets/textures/DiamondPlate001_1K-JPG/DiamondPlate001_1K-JPG",
  DiamondPlate002: "/assets/textures/DiamondPlate002_1K-JPG/DiamondPlate002_1K-JPG",
  MetalPlates: "/assets/textures/MetalPlates006_1K-JPG/MetalPlates006_1K-JPG",
  MetalPlates003: "/assets/textures/MetalPlates003_1K-JPG/MetalPlates003_1K-JPG",
  MetalPlates004: "/assets/textures/MetalPlates004_1K-JPG/MetalPlates004_1K-JPG",
  MetalPlates005: "/assets/textures/MetalPlates005_1K-JPG/MetalPlates005_1K-JPG",
};
...
export function useGalleryTextures(textureUrl, fallbackType = 'WALL') {
  ...
  const resolvedPath = textureUrl && !textureUrl.includes("/") 
  ...
  const maps = {};
  const mapTypes = ['Color', 'Normal', 'Roughness', 'Metalness', 'AmbientOcclusion'];
  
  mapTypes.forEach(type => {
    const key = type.toLowerCase() === 'ambientocclusion' ? 'ao' : type.toLowerCase();
    try {
      if (finalPath) {
